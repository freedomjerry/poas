...
path = os.getcwd()
logging.config.fileConfig("Post\\main\\logging.conf")
logger = logging.getLogger()
# loggerInfo = logging.getLogger("TimeInfoLogger")
# Consolelogger = logging.getLogger("ConsoleLogger")

conf = configparser.ConfigParser()
conf.read("Post\\main\\setting.conf") 
trainfile=""
...
def run(keyword):
    trainfile1 = "C:\\Users\\Administrator\\Desktop\\毕设\\程序\\data_full_{keyword}.dat".format(keyword = keyword)
