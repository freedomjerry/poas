...
def get_data(keyword):
    jieba.load_userdict("Post/main/SogouLabDic.txt")
    jieba.load_userdict("Post/main/dict_baidu_utf8.txt")
    jieba.load_userdict("Post/main/dict_pangu.txt")
    jieba.load_userdict("Post/main/dict_sougou_utf8.txt")
    jieba.load_userdict("Post/main/dict_tencent_utf8.txt")
    jieba.load_userdict("Post/main/my_dict.txt")
    stopwords = {}.fromkeys([ line.rstrip() for line in open('Post/main/Stopword.txt',encoding='utf-8') ])
    print("连接MySql数据库...")
    ...
    for n in range(1,index):
        ...
        fo = open("C:\\Users\\Administrator\\Desktop\\毕设\\程序\\data_full_{keyword}.dat".format(keyword = keyword), "a+",encoding='utf-8')
